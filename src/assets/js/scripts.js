...
jQuery(function () {
    ...
    function api_data() {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "https://covid-19-coronavirus-statistics.p.rapidapi.com/v1/stats?country=Colombia",
            "method": "GET",
            "headers": {
        ...
        $.ajax(settings).done(function (response) {
            ...
            var lastupdate = response.data.covid19Stats[0].lastUpdate;
            var confirmed = response.data.covid19Stats[0].confirmed;
            var deaths = response.data.covid19Stats[0].deaths;
            var recovered = response.data.covid19Stats[0].recovered;
